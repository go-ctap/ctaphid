// Code generated by "stringer -type=Command,ClientPINSubCommand,BioEnrollmentSubCommand,CredentialManagementSubCommand,ConfigSubCommand,Permission -output=consts_string.go"; DO NOT EDIT.
