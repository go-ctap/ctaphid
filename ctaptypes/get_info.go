...
type AuthenticatorGetInfoResponse struct {
	...
	Extensions                       []webauthntypes.ExtensionIdentifier           `cbor:"2,keyasint" json:"extensions,omitempty"`
	...
	Algorithms                       []webauthntypes.PublicKeyCredentialParameters `cbor:"10,keyasint" json:"algorithms,omitempty"`
